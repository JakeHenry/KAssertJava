 ...
 *
 * <p>
 * Create instances with {@link #ok(Object)} and {@link #err(Class,
 * RuntimeException)}. Query the variant with {@link #ok()} / {@link #err()},
 * extract values with {@link #get()} / {@link #getOr(Object)}, and chain
 * operations with {@link #map(Function)}, {@link #andThen(Function)}, etc.
 *
...
public final class KResult<T>
{
     ...
     * modifying it. Callers must not mutate the contained exception through the
     * consumer.
     *
     * @param consumer the observing consumer
     * @return this result
